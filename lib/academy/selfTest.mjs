...
ok("119 XP is still Novice", game.getLevel(119).name === "Novice");
ok("120 XP reaches Foundation", game.getLevel(120).name === "Foundation");
ok("2600 XP is Professional", game.getLevel(2600).name === "Professional");
ok("top level has no next", game.getLevel(9999).next === null);
ok("percentToNext stays in range", [0, 50, 130, 800, 9999].every((xp) => {
