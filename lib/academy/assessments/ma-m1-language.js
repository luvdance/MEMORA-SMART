    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "c", text: "They should have written 15x²" },
        ...
        whyWrong: {
          ...
          c: "15x² would come from MULTIPLYING 5x by 3x. The question adds them.",
      ...
      },
      {
        ...
        prompt:
          "A question asks for the circumference of a circle of radius 7 cm and says 'give your answer in terms of π'. Which answer is correct?",
        options: [
          { id: "a", text: "44 cm" },
          { id: "b", text: "43.98 cm" },
          { id: "c", text: "14π cm" },
          { id: "d", text: "22/7 × 14 cm" },
        ],
        correct: "c",
        explanation:
          "Circumference is 2πr = 2 × π × 7 = 14π. 'In terms of π' means keep π as a symbol, so 14π cm is the finished answer.",
        whyWrong: {
          a: "44 is 14π worked out with π as 22/7. The instruction specifically asked you not to do that step.",
          b: "Same problem, with a more accurate value of π. Accuracy is not the issue; the form is.",
          d: "That is unfinished working rather than an answer, and it has already substituted a value for π.",
        },
      },
      {
        id: "maq5-5",
    ...
    questions: [
      {
        ...
        prompt:
          "Part (a) asks you to factorise x² − 16. Part (b) says 'Hence solve x² − 16 = 0.' What does 'hence' instruct you to do?",
        options: [
          { id: "a", text: "Start part (b) again from the beginning" },
          { id: "b", text: "Use the factorisation from part (a) to write down the roots" },
          { id: "c", text: "Use the quadratic formula, since it always works" },
          { id: "d", text: "Check that part (a) was correct" },
        ],
        correct: "b",
        explanation:
          "(a) gives (x − 4)(x + 4). 'Hence' means use it: if a product is zero then one of the factors is zero, so x = 4 or x = −4. Two lines.",
        whyWrong: {
          a: "That is what 'hence' exists to stop you doing. The hard work has already been done and marked in part (a).",
          c: "The formula would give the same answer much more slowly, and where the word is 'hence' rather than 'hence or otherwise' it may earn no marks at all.",
          d: "Checking is sensible, but it is not what the word instructs. 'Hence' is about using the result, not verifying it.",
        },
      },
      {
        id: "maq6-2",
        ...
        prompt:
          "A 4-mark question says 'Show that (n + 3)² − n² = 6n + 9.' A candidate writes only '= 6n + 9'. Roughly what will they score?",
        options: [
        ...
        correct: "b",
        explanation:
          "In a 'show that' the answer is printed in the question, so it cannot be what is being marked. The marks are for the expansion, the removal of the bracket and the cancellation — the steps the candidate left out.",
        whyWrong: {
          a: "Copying the given answer demonstrates nothing. The examiner already knows it is 6n + 9; that is why they printed it.",
  ...
  "ma-l7-parts": {
    ...
    questions: [
      ...
      },
      {
        ...
        prompt: "In the expression 4x² − 7x + 2, what is the coefficient of x?",
        options: [
          { id: "a", text: "7" },
          { id: "b", text: "−7" },
          { id: "c", text: "4" },
        ...
        correct: "b",
        explanation:
          "The coefficient is the number multiplying the letter, and the sign in front of a term belongs to that term. The x term is −7x, so the coefficient of x is −7.",
        whyWrong: {
          a: "The digits are right and the sign has been dropped. In the quadratic formula this exact slip puts the wrong value of b in and produces two wrong roots from perfect arithmetic.",
          c: "4 is the coefficient of x², not of x.",
          d: "2 is the constant term — the one with no letter attached.",
        },
      },
      {
        id: "maq7-3",
      ...
      },
      {
        ...
        options: [
          ...
          { id: "c", text: "A = πr², because it contains an equals sign" },
        ...
        whyWrong: {
          ...
          c: "A = πr² is a formula: a general rule relating quantities, true for every circle. You can substitute into it or change its subject, but on its own there is no particular unknown to find.",
