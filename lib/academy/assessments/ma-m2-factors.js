...
export const ASSESSMENTS = {
  /* ═══════════════════════════════════════════════════════════════════ */
  "ma-l21-factors-multiples": {
    lessonId: "ma-l21-factors-multiples",
    passMark: 70,
    questions: [
      {
        id: "maq21-1",
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "The primes up to 9, because √97 is about 9.8: so 2, 3, 5 and 7" },
          { id: "c", text: "Only 2 and 3" },
          { id: "d", text: "Every odd number up to 97" },
        ],
        correct: "b",
        explanation:
          "Factors come in pairs, so a factor above the square root would have a partner below it that you would have found first. Testing the primes up to √97 is enough.",
        whyWrong: {
